...
public class FileDialog extends ListActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_SD_READ_PERMISSION) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        selectButton.setOnClickListener(new OnClickListener() {
            ...
            @Override public void onClick(View v) {
                if (selectedFile != null) {
                    ...
                    // keep track of the last selected file location
        ...
        if ((startPath == null) || startPath.isEmpty()) {
            // start from the last selected file location (if any)
            startPath = (!lastSelectedPath.isEmpty()) ? lastSelectedPath : ROOT;
        }

        // ask for storage read permission, if needed
        if ((Build.VERSION.SDK_INT >= 23) && (ContextCompat.checkSelfPermission(this, READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
    ...
    private void getDir(@NonNull String dirPath) {
        ...
        for (File file : files) {
            if (file.isDirectory()) {
                ...
                if (formatFilter != null) {
                    ...
                    for (String filter : formatFilter) {
                        final String formatLwr = filter.toLowerCase();
    ...
    private void addItem(@NonNull ArrayList<HashMap<String, Object>> list, String fileName, int imageId) {
    ...
    private void setSelectVisible(@NonNull View v) {
